...
import net.corda.core.node.services.NoopTelemetryService
...
open class InternalMockNetwork(cordappPackages: List<String> = emptyList(),
    ...
    open class MockNode(
        ...
        override fun makeKeyManagementService(identityService: PersistentIdentityService): KeyManagementServiceInternal {
            return BasicHSMKeyManagementService(cacheFactory, identityService, database, cryptoService, NoopTelemetryService())
        }
