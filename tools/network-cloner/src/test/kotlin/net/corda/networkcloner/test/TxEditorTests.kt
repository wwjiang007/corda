...
class TxEditorTests {
    ...
    fun `Public key in a transaction can be replaced`() {
        val pathToTestDb = TxEditorTests::class.java.getResource("/snapshots/source/persistence.mv.db").path.removeSuffix(".mv.db")
        ...
        val pathToCordapps = TxEditorTests::class.java.getResource("/snapshots/source/cordapps").path
